...
func_header:  tipo_stat  TK_IDENTIFICADOR lista_par_begin lista_par lista_par_end{$$ = insere_nodo(NULL,$2);$$->reg = geraRotulo(&ultimoRotulo);tabelas.insereFun(get_line_number(),$2,ultimoRotulo);tabelas.atualizaFunTipoPar($2,$1);tabelas.setRotuloFun($2,$$->reg); ListaInst ListI; if($4==NULL){ListI = ListaInst();}else{ListI = $4->cod;} $$->cod.appendCodigoInicio(geraDeclaFunc($$->reg,&ultimoReg,&instId,ListI,GERA_FUN,string($2->tk_value.vStr))); atualiza_tipo_semantico($$,$1); }
|tipo_stat  TK_IDENTIFICADOR lista_par_begin lista_par_end{$$ = insere_nodo(NULL,$2);$$->reg = geraRotulo(&ultimoRotulo);tabelas.insereFun(get_line_number(),$2,ultimoRotulo);tabelas.atualizaFunTipoPar($2,$1); tabelas.setRotuloFun($2,$$->reg); $$->cod.appendCodigoInicio(geraDeclaFunc($$->reg,&ultimoReg,&instId,ListaInst(),GERA_FUN,string($2->tk_value.vStr))); atualiza_tipo_semantico($$,$1);};
...
ret_cont_break: TK_PR_RETURN exp {$$ = insere_nodo($2,geraVal(TIPO_RSV_WRD,NOT_LIT,get_line_number(),(char*)"return"));tabelas.verificaReturn($2->tipo_valor_semantico,get_line_number());$$->cod.appendCodigoInicio(geraInstReturn($2->reg,&ultimoReg,&instId,GERA_RET,"")); $$->cod.appendCodigoInicio($2->cod.getCodigo());}
...
| var_vet {$$ = $1;$$->reg = geraRegistrador(&ultimoReg);DadoTabelaSimbolos dado = tabelas.getSimboloPorValorLex($1->valor_lexico); list<Instrucao> listaI = list<Instrucao>(); listaI = geraLeituraVar($$->reg,dado.deslocamento,dado.escopo,&ultimoReg,&ultimoRotulo,&instId,GERA_LEIT,string($1->valor_lexico->tk_value.vStr)); $$->cod.appendCodigoInicio(listaI); }
| fun_call {$$ = $1;} 
| '(' exp ')' {$$ = $2; libera_val($1); libera_val($3);} 
| exp_unitaria {$$ = $1;} 
| exp '+' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));$$->reg =geraRegistrador(&ultimoReg);$$->cod.appendInstCodigo(geraInst3op("add",$1->reg,$3->reg,$$->reg,INST_ARITLOG,&instId,GERA_ARIT,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp '-' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));$$->reg =geraRegistrador(&ultimoReg);$$->cod.appendInstCodigo(geraInst3op("sub",$1->reg,$3->reg,$$->reg,INST_ARITLOG,&instId,GERA_ARIT,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp '*' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));$$->reg =geraRegistrador(&ultimoReg);$$->cod.appendInstCodigo(geraInst3op("mult",$1->reg,$3->reg,$$->reg,INST_ARITLOG,&instId,GERA_ARIT,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp '/' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));$$->reg =geraRegistrador(&ultimoReg);$$->cod.appendInstCodigo(geraInst3op("div",$1->reg,$3->reg,$$->reg,INST_ARITLOG,&instId,GERA_ARIT,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp '%' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));}
| exp '|' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));}
| exp '&' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));}
| exp '^' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,tabelas.infereTipo($1,$3));}
| exp TK_OC_LE exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);$$->reg = geraRegistrador(&ultimoReg);Instrucao inst =geraInst3op("cbr","x","y",$$->reg,INST_CBR,&instId,GERA_REL,"");$$->idRemendosTrue.push_front(inst.id);$$->idRemendosFalse.push_front(inst.id);$$->cod.appendInstCodigo(inst);$$->cod.appendInstCodigo(geraInst3op("cmp_LE",$1->reg,$3->reg,$$->reg,INST_REL,&instId,GERA_REL,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp TK_OC_GE exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);$$->reg = geraRegistrador(&ultimoReg);Instrucao inst =geraInst3op("cbr","x","y",$$->reg,INST_CBR,&instId,GERA_REL,"");$$->idRemendosTrue.push_front(inst.id);$$->idRemendosFalse.push_front(inst.id);$$->cod.appendInstCodigo(inst);$$->cod.appendInstCodigo(geraInst3op("cmp_GE",$1->reg,$3->reg,$$->reg,INST_REL,&instId,GERA_REL,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp TK_OC_EQ exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);$$->reg = geraRegistrador(&ultimoReg);Instrucao inst =geraInst3op("cbr","x","y",$$->reg,INST_CBR,&instId,GERA_REL,"");$$->idRemendosTrue.push_front(inst.id);$$->idRemendosFalse.push_front(inst.id);$$->cod.appendInstCodigo(inst);$$->cod.appendInstCodigo(geraInst3op("cmp_EQ",$1->reg,$3->reg,$$->reg,INST_REL,&instId,GERA_REL,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp TK_OC_NE exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);$$->reg = geraRegistrador(&ultimoReg);Instrucao inst =geraInst3op("cbr","x","y",$$->reg,INST_CBR,&instId,GERA_REL,"");$$->idRemendosTrue.push_front(inst.id);$$->idRemendosFalse.push_front(inst.id);$$->cod.appendInstCodigo(inst);$$->cod.appendInstCodigo(geraInst3op("cmp_NE",$1->reg,$3->reg,$$->reg,INST_REL,&instId,GERA_REL,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp TK_OC_AND exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);string rotTrue = geraRotulo(&ultimoRotulo); Instrucao nopInst = geraInst2op(rotTrue,"","",INST_NOP_ROT,&instId,GERA_ROT,""); $$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendInstCodigo(nopInst);$1->cod.remendaTrue($1->idRemendosTrue,rotTrue);$1->idRemendosTrue.clear();$$->cod.appendCodigoInicio($1->cod.getCodigo());appendListaTrue($$,$3->idRemendosTrue);appendListaFalse($$,$3->idRemendosFalse); appendListaFalse($$,$1->idRemendosFalse); }
| exp TK_OC_OR exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);string rotFalse = geraRotulo(&ultimoRotulo); Instrucao nopInst = geraInst2op(rotFalse,"","",INST_NOP_ROT,&instId,GERA_ROT,""); $$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendInstCodigo(nopInst);$1->cod.remendaFalse($1->idRemendosFalse,rotFalse);$1->idRemendosFalse.clear();$$->cod.appendCodigoInicio($1->cod.getCodigo());appendListaTrue($$,$3->idRemendosTrue);appendListaFalse($$,$3->idRemendosFalse); appendListaTrue($$,$1->idRemendosTrue);}
| exp '<' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);$$->reg = geraRegistrador(&ultimoReg);Instrucao inst =geraInst3op("cbr","x","y",$$->reg,INST_CBR,&instId,GERA_REL,"");$$->idRemendosTrue.push_front(inst.id);$$->idRemendosFalse.push_front(inst.id);$$->cod.appendInstCodigo(inst);$$->cod.appendInstCodigo(geraInst3op("cmp_LT",$1->reg,$3->reg,$$->reg,INST_REL,&instId,GERA_REL,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
| exp '>' exp { $$ = insere_nodo(NULL,$2); insere_filho($$,$1); insere_filho($$,$3);atualiza_tipo_semantico($$,ID_BOOL);$$->reg = geraRegistrador(&ultimoReg);Instrucao inst =geraInst3op("cbr","x","y",$$->reg,INST_CBR,&instId,GERA_REL,"");$$->idRemendosTrue.push_front(inst.id);$$->idRemendosFalse.push_front(inst.id);$$->cod.appendInstCodigo(inst);$$->cod.appendInstCodigo(geraInst3op("cmp_GT",$1->reg,$3->reg,$$->reg,INST_REL,&instId,GERA_REL,""));$$->cod.appendCodigoInicio($3->cod.getCodigo());$$->cod.appendCodigoInicio($1->cod.getCodigo());}
